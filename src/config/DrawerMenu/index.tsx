...

  {
    ...
    subItems: [
      ...
      },
      {
        ...
        iconColor: colors.gray[300],
        title: 'Relatórios',
        slug: '/extranet/relatorios?filterType=cobrancas',
      },
    ],
...

  {
    ...
    subItems: [
      ...
      },
      {
        ...
        iconColor: colors.gray[300],
        title: 'Relatórios',
        slug: '/extranet/relatorios?filterType=eventos',
      },
    ],
...

  {
    ...
    subItems: [
      ...
      },
      {
        ...
        iconColor: colors.gray[300],
        title: 'Relatórios',
        slug: '/extranet/relatorios?filterType=provas',
      },
    ],
...

  {
    ...
    subItems: [
      ...
      },
      {
        ...
        iconColor: colors.gray[300],
        title: 'Relatórios',
        slug: '/extranet/relatorios?filterType=resultados',
      },
    ],
    icon: <IoMdAnalytics />,
    iconColor: colors.gray[300],
